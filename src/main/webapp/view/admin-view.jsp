...
<section>
    <br>
    <form class="filter" style="width: 20%;float: left" action="/admin/loc" method="post">
        <div class="one">
            <button class="btn btn-warning"> <a style="text-decoration: none" href="/admin">All</a></button>
            <hr>
    ...
    <form action="/admin/loc/gia" method="post" style="width: 20%;float: left">
        <div id="popup2" class="overlay light">
            <a class="cancel" href="#"></a>
            <div class="popup">
                    <input type="number" name="gia1" placeholder="Min">
                    <br> to <br>
                    <input type="number" name="gia2" placeholder="Max">
    ...
    <article style="width: 80%; float: left">
        <table class="table table-hover table-bordered">
            ...
            <tbody>
            <c:forEach items="${listXeDaps}" var="x">
                <tr>
                    <td>${x.id}</td>
                    <td>${x.ten}</td>
                    <td>${x.moTa}</td>
                    ...
                    <td>
                        <a href="/admin/xoa?idX=${x.id}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                        <a href="#" class="btn btn-success"><i class="fa-solid fa-circle-info"></i></a>
                        <a href="/admin/view?id=${x.id}" class="btn btn-primary"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
